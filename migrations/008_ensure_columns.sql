-- 008_ensure_columns.sql
-- Idempotent, no DO blocks, no FK constraints — maximum compatibility
ALTER TABLE projects ADD COLUMN IF NOT EXISTS is_budget_item boolean NOT NULL DEFAULT false;
ALTER TABLE projects ADD COLUMN IF NOT EXISTS linked_budget_item_id uuid;

UPDATE projects SET is_budget_item = true
WHERE id IN (
